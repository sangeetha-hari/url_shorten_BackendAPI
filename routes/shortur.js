...
import {createNewUrl, getUrlByShortUrl,getAllUrl,getUrlBymonth } from "../dbhelper.js";
...
// API for dashboard
    router.get("/dashboard",async(req,res)=>{
        try {
            ...
            const date= Date(); console.log(date);
            const month= date.slice(4,7); console.log(month);
            const allurl= await getUrlBymonth(month);
